...
minimal_deps = %w(browser-prefix base compiler/parser compiler/base compiler/ast utils compiler/compiler compiler/compiler.patch runtime browser-suffix).map do |file|
